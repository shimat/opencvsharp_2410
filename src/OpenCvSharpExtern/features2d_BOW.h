...
{
	return obj->descripotorsCount(); // typo!
}
...
CVAPI(cv::BOWKMeansTrainer*) features2d_BOWKMeansTrainer_new(
	int clusterCount, CvTermCriteria termcrit, int attempts, int flags)
{
...
CVAPI(void) features2d_BOWImgDescriptorExtractor_compute1(
