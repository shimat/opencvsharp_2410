...
namespace OpenCvSharp
{
    public static partial class Cv
    {
        ...
        public static void GEMM(CvArr src1, CvArr src2, double alpha, CvArr src3, double beta, CvArr dst, GemmOperation tAbc)
        {
            ...
            NativeMethods.cvGEMM(src1.CvPtr, src2.CvPtr, alpha, ToPtr(src3), beta, dst.CvPtr, tAbc);
            KeepAlive(src1, src2, src3, beta, dst);
        }
#if LANG_JP
        /// <summary>
        /// 行列の乗算を行う.
        ...
        {
            var ret = NativeMethods.cvGet1D(arr.CvPtr, idx0);
            KeepAlive(arr);
            return ret;
        }
#if LANG_JP
        ...
        {
            var ret = NativeMethods.cvGet2D(arr.CvPtr, idx0, idx1); 
            KeepAlive(arr);
            return ret;
        }
#if LANG_JP
        ...
        {
            var ret = NativeMethods.cvGet3D(arr.CvPtr, idx0, idx1, idx2);
            KeepAlive(arr);
            return ret;
        }
#if LANG_JP
        ...
        {
            var ret = NativeMethods.cvGetND(arr.CvPtr, idx);
            KeepAlive(arr);
            return ret;
        }
        #endregion
        ...
        public static CvMat GetAffineTransform(CvPoint2D32f[] src, CvPoint2D32f[] dst, out CvMat mapMatrix)
        {
            ...
            IntPtr mapMatrixPtr = NativeMethods.cvCreateMat(2, 3, MatrixType.F32C1);
            NativeMethods.cvGetAffineTransform(src, dst, mapMatrixPtr);
        ...
        public static double GetCaptureProperty(CvCapture capture, int propertyId)
        {
            ...
            var ret = NativeMethods.cvGetCaptureProperty(capture.CvPtr, propertyId);
        ...
        public static double GetCentralMoment(CvMoments moments, int xOrder, int yOrder)
        {
            ...
            var ret = NativeMethods.cvGetCentralMoment(moments, xOrder, yOrder);
            GC.KeepAlive(moments);
            return ret;
        }
        #endregion
        #region GetCol
        ...
        public static CvMat GetCols(CvArr arr, out CvMat submat, int startCol, int endCol)
        {
            ...
            IntPtr result = NativeMethods.cvGetCols(arr.CvPtr, submat.CvPtr, startCol, endCol);
            KeepAlive(arr);
        ...
        public static CvMat GetDiag(CvArr arr, out CvMat submat, DiagType diag)
        {
            ...
            submat = new CvMat(false);
            IntPtr result = NativeMethods.cvGetDiag(arr.CvPtr, submat.CvPtr, diag);
            KeepAlive(arr);
            return new CvMat(result, false);
        }
        #endregion
        ...
        public static int GetDims(CvArr arr)
        {
            ...
            var ret = NativeMethods.cvGetDims(arr.CvPtr, IntPtr.Zero);
            KeepAlive(arr);
            return ret;
        }
#if LANG_JP
        ...
        public static int GetDims(CvArr arr, out int[] sizes)
        {
            ...
            {
                var ret = NativeMethods.cvGetDims(arr.CvPtr, sizesPtr.Pointer);
                KeepAlive(arr);
                return ret;
            }
        }
        ...
        public static int GetDimSize(CvArr arr, int index)
        {
            if (arr == null)
                throw new ArgumentNullException("arr");
            var ret = NativeMethods.cvGetDimSize(arr.CvPtr, index);
            KeepAlive(arr);
            return ret;
        }
        #endregion
        ...
        public static MatrixType GetElemType(CvArr arr)
        {
            ...
            var ret = (MatrixType)NativeMethods.cvGetElemType(arr.CvPtr);
            KeepAlive(arr);
            return ret;
        }
        #endregion
        ...
        {
            return NativeMethods.cvGetErrMode();
        }
        #endregion
        #region GetErrStatus
#if LANG_JP
        ...
        {
            return NativeMethods.cvGetErrStatus();
        }
        #endregion
        #region GetFileNode
#if LANG_JP
        ...
        public static CvFileNode GetFileNode(CvFileStorage fs, CvFileNode map, CvStringHashNode key, bool createMissing)
        {
            ...
            IntPtr result = NativeMethods.cvGetFileNode(fs.CvPtr, ToPtr(map), ToPtr(key), createMissing);
            KeepAlive(fs, map, key);
        ...
        {
            var ret = NativeMethods.cvGetFileNodeName(ToPtr(node));
            KeepAlive(node);
            return ret;
        }
        #endregion
        ...
        public static CvFileNode GetFileNodeByName(CvFileStorage fs, CvFileNode map, string name)
        {
            ...
            IntPtr result = NativeMethods.cvGetFileNodeByName(fs.CvPtr, ToPtr(map), name);
            KeepAlive(map, fs);
            if (result != IntPtr.Zero)
                return new CvFileNode(result);
            else
        ...
        public static CvStringHashNode GetHashedKey(CvFileStorage fs, string name, bool createMissing)
        {
            ...
            if (string.IsNullOrEmpty(name))
                throw new ArgumentNullException("name");
            IntPtr result = NativeMethods.cvGetHashedKey(fs.CvPtr, name, name.Length, createMissing);
            GC.KeepAlive(fs);
            if (result != IntPtr.Zero)
        ...
        {
            MatrixType type;
            return NativeMethods.cvPtr1D(hist.BinsPtr, idx0, out type);
        }
#if LANG_JP
        /// <summary>
        ...
        {
            MatrixType type;
            var ret = NativeMethods.cvPtr2D(hist.BinsPtr, idx0, idx1, out type);
            GC.KeepAlive(hist);
            return ret;
        }
#if LANG_JP
        ...
        {
            MatrixType type;
            var ret = NativeMethods.cvPtr3D(hist.BinsPtr, idx0, idx1, idx2, out type);
            GC.KeepAlive(hist);
            return ret;
        }
#if LANG_JP
        ...
        {
            MatrixType type;
            var ret = NativeMethods.cvPtrND(hist.BinsPtr, idx, out type, true, IntPtr.Zero);
            GC.KeepAlive(hist);
            return ret;
        }
        #endregion
        ...
        public static void GetHuMoments(CvMoments moments, out CvHuMoments humoments)
        {
            ...
            NativeMethods.cvGetHuMoments(moments, humoments);
            GC.KeepAlive(moments);
        }
        #endregion
        #region GetImage
        ...
        public static IplImage GetImage(CvArr arr, out IplImage imageHeader)
        {
            ...
            IntPtr ptr = NativeMethods.cvGetImage(arr.CvPtr, imageHeader.CvPtr);
            GC.KeepAlive(arr);
            if (ptr == IntPtr.Zero)
                return null;
        ...
        public static int GetImageCOI(IplImage image)
        {
            ...
            var ret = NativeMethods.cvGetImageCOI(image.CvPtr);
            GC.KeepAlive(image);
            return ret;
        }
        #endregion
        ...
        public static CvRect GetImageROI(IplImage image)
        {
            ...
            var ret = NativeMethods.cvGetImageROI(image.CvPtr);
            GC.KeepAlive(image);
            return ret;
        }
        #endregion
        ...
        public static CvMat GetMat(CvArr arr, out CvMat header, out int coi, bool allowND)
        {
            ...
            IntPtr ptr = NativeMethods.cvGetMat(arr.CvPtr, header.CvPtr, out coi, allowND);
            GC.KeepAlive(arr);
            if (ptr == IntPtr.Zero)
                return null;
            else
        ...
        public static void GetMinMaxHistValue(CvHistogram hist, out float minValue, out float maxValue, out int[] minIdx, out int[] maxIdx)
        {
            ...
            NativeMethods.cvGetMinMaxHistValue(hist.CvPtr, ref minValueTemp, ref maxValueTemp, minIdxTemp, maxIdxTemp);
        ...
        public static void GetModuleInfo(string moduleName, out string version, out string loadedAddonPlugins)
        {
            ...
            NativeMethods.cvGetModuleInfo(moduleName, ref versionPtr, ref loadedAddonPluginsPtr);
        ...
        public static double GetNormalizedCentralMoment(CvMoments moments, int xOrder, int yOrder)
        {
            ...
            var ret = NativeMethods.cvGetNormalizedCentralMoment(moments, xOrder, yOrder);
            GC.KeepAlive(moments);
            return ret;
        }
        #endregion
        ...
        {
            return NativeMethods.cvGetNumThreads();
        }
        #endregion
        ...
        public static void GetOptimalNewCameraMatrix(CvMat cameraMatrix, CvMat distCoeffs, CvSize imageSize, double alpha, CvMat newCameraMatrix, CvSize newImageSize, out CvRect validPixROI)
        {
            ...
            NativeMethods.cvGetOptimalNewCameraMatrix(cameraMatrix.CvPtr, distCoeffs.CvPtr, imageSize, alpha, newCameraMatrix.CvPtr, newImageSize, out validPixROI);
            KeepAlive(cameraMatrix, distCoeffs, newCameraMatrix);
        }
        #endregion
        ...
        public static CvMat GetPerspectiveTransform(CvPoint2D32f[] src, CvPoint2D32f[] dst, out CvMat mapMatrix)
        {
            ...
            IntPtr mapMatrixPtr = NativeMethods.cvCreateMat(3, 3, MatrixType.F32C1);
            NativeMethods.cvGetPerspectiveTransform(src, dst, mapMatrixPtr);
            mapMatrix = new CvMat(mapMatrixPtr);
            return mapMatrix;
        }
#if LANG_JP
        ...
        public static void GetQuadrangleSubPix(CvArr src, CvArr dst, CvMat mapMatrix)
        {
            ...
            NativeMethods.cvGetQuadrangleSubPix(src.CvPtr, dst.CvPtr, mapMatrix.CvPtr);
            KeepAlive(src, dst, mapMatrix);
        }
        #endregion
        #region GetRawData
#if LANG_JP
        ...
        public static void GetRawData(CvArr arr, out IntPtr data, out int step, out CvSize roiSize)
        {
            ...
            step = 1;
            roiSize = new CvSize();
            NativeMethods.cvGetRawData(arr.CvPtr, ref data, ref step, ref roiSize);
            KeepAlive(arr);
        }
        #endregion
        #region GetReal*D
        ...
        {
            var ret = NativeMethods.cvGetReal1D(arr.CvPtr, idx0);
            GC.KeepAlive(arr);
            return ret;
        }
#if LANG_JP
        ...
        {
            var ret = NativeMethods.cvGetReal2D(arr.CvPtr, idx0, idx1);
            GC.KeepAlive(arr);
            return ret;
        }
#if LANG_JP
        ...
        {
            var ret = NativeMethods.cvGetReal3D(arr.CvPtr, idx0, idx1, idx2);
            GC.KeepAlive(arr);
            return ret;
        }
#if LANG_JP
        ...
        {
            var ret = NativeMethods.cvGetRealND(arr.CvPtr, idx);
            GC.KeepAlive(arr);
            return ret;
        }
        #endregion
        ...
        public static void GetRectSubPix(CvArr src, CvArr dst, CvPoint2D32f center)
        {
            ...
            if (dst == null)
                throw new ArgumentNullException("dst");
            NativeMethods.cvGetRectSubPix(src.CvPtr, dst.CvPtr, center);
            KeepAlive(src, dst);
        }
        #endregion
        ...
        public static CvFileNode GetRootFileNode(CvFileStorage fs, int streamIndex)
        {
            if (fs == null)
                throw new ArgumentNullException("fs");
            IntPtr result = NativeMethods.cvGetRootFileNode(fs.CvPtr, streamIndex);
            GC.KeepAlive(fs);
            if (result != IntPtr.Zero)
                return new CvFileNode(result);
            return null;
        ...
        {
            IntPtr mapMatrixPtr = NativeMethods.cvCreateMat(2, 3, MatrixType.F32C1);
            NativeMethods.cv2DRotationMatrix(center, angle, scale, mapMatrixPtr);
            mapMatrix = new CvMat(mapMatrixPtr);
            return mapMatrix;
        }
        #endregion
        ...
        public static CvMat GetRows(CvArr arr, out CvMat submat, int startRow, int endRow, int deltaRow)
        {
            ...
            submat = new CvMat(false);
            IntPtr result = NativeMethods.cvGetRows(arr.CvPtr, submat.CvPtr, startRow, endRow, deltaRow);
            GC.KeepAlive(arr);
            return new CvMat(result, false);
        }
        #endregion
        ...
        public static T? GetSeqElem<T>(CvSeq seq, int index) where T : struct
        {
            ...
            IntPtr result = NativeMethods.cvGetSeqElem(seq.CvPtr, index);
            GC.KeepAlive(seq);
            if (result == IntPtr.Zero)
                return null;
        ...
        public static int GetSeqReaderPos(CvSeqReader reader)
        {
            ...
            var ret = NativeMethods.cvGetSeqReaderPos(reader.CvPtr);
            GC.KeepAlive(reader);
            return ret;
        }
        #endregion
        ...
        internal static IntPtr GetSetElemInternal(CvSet setHeader, int index)
        {
            unsafe
            {
                WCvSetElem* elem = (WCvSetElem*)NativeMethods.cvGetSeqElem(setHeader.CvPtr, index);
        ...
        public static CvSize GetSize(CvArr arr)
        {
            if (arr == null)
                throw new ArgumentNullException("arr");
            var ret = NativeMethods.cvGetSize(arr.CvPtr);
            GC.KeepAlive(arr);
            return ret;
        }
        #endregion
        ...
        public static double GetSpatialMoment(CvMoments moments, int xOrder, int yOrder)
        {
            ...
            var ret = NativeMethods.cvGetSpatialMoment(moments, xOrder, yOrder);
            GC.KeepAlive(moments);
            return ret;
        }
        #endregion
        ...
        public static CvMat GetSubRect(CvArr arr, out CvMat submat, CvRect rect)
        {
            ...
            submat = new CvMat(false);
            IntPtr result = NativeMethods.cvGetSubRect(arr.CvPtr, submat.CvPtr, rect);
            GC.KeepAlive(arr);
            return new CvMat(result, false);
        }
#if LANG_JP
        ...
        public static void GetTextSize(string textString, CvFont font, out CvSize textSize, out int baseline)
        {
            ...
            NativeMethods.cvGetTextSize(textString, font.CvPtr, out textSize, out baseline);
            GC.KeepAlive(font);
        }
        #endregion
        #region GetTickCount
        ...
        {
            return NativeMethods.cvGetTickCount();
        }
        #endregion
        ...
        {
            return NativeMethods.cvGetTickFrequency();
        }
        #endregion
        #region GetThreadNum
#if LANG_JP
        ...
        {
            return NativeMethods.cvGetThreadNum();
        }
        #endregion
        ...
        {
            return NativeMethods.cvGetTrackbarPos(trackbarName, windowName);
        }
        #endregion
...
// ReSharper restore InconsistentNaming
        {
            return NativeMethods.cvGetValidDisparityROI(roi1, roi2, minDisparity, numberOfDisparities, SADWindowSize);
        }
        #endregion
        ...
        {
            return NativeMethods.cvGetWindowHandle(name);
        }
        #endregion
        ...
        {
            return NativeMethods.cvGetWindowName(windowHandle);
        }
        #endregion
        ...
        public static WindowPropertyValue GetWindowProperty(string name, WindowProperty propId)
        {
            ...
            return (WindowPropertyValue)(int)NativeMethods.cvGetWindowProperty(name, propId);
        }
        #endregion
        ...
        public static void GoodFeaturesToTrack(CvArr image, CvArr eigImage, CvArr tempImage, out CvPoint2D32f[] corners, ref int cornerCount, double qualityLevel, double minDistance, CvArr mask, int blockSize, bool useHarris, double k)
        {
            ...
            NativeMethods.cvGoodFeaturesToTrack(
                image.CvPtr, eigImage.CvPtr, tempImage.CvPtr, corners, ref cornerCount, qualityLevel, minDistance, ToPtr(mask), blockSize, useHarris, k);
            KeepAlive(image, eigImage, tempImage);
        }
        #endregion
        #region GrabFrame
#if LANG_JP
        ...
        public static int GrabFrame(CvCapture capture)
        {
            if (capture == null)
                throw new ArgumentNullException("capture");
            var ret = NativeMethods.cvGrabFrame(capture.CvPtr);
            GC.KeepAlive(capture);
            return ret;
        }
        #endregion
        ...
        public static int GraphAddVtx(CvGraph graph, CvGraphVtx vtx)
        {
            ...
            var ret = NativeMethods.cvGraphAddVtx(graph.CvPtr, ToPtr(vtx), ref insertedVtxPtr);
            KeepAlive(graph, vtx);
            return ret;
        }
#if LANG_JP
        ...
        public static int GraphAddVtx(CvGraph graph, CvGraphVtx vtx, out CvGraphVtx insertedVtx)
        {
            ...
            var ret = NativeMethods.cvGraphAddVtx(graph.CvPtr, ToPtr(vtx), ref insertedVtxPtr);
            KeepAlive(graph, vtx, insertedVtx);
            return ret;
        }
        #endregion
        #region GraphAddEdge
        ...
        public static int GraphAddEdge(CvGraph graph, int startIdx, int endIdx, CvGraphEdge edge, IntPtr insertedEdge)
        {
            ...
            var ret = NativeMethods.cvGraphAddEdge(graph.CvPtr, startIdx, endIdx, ToPtr(edge), ref insertedEdge);
            KeepAlive(graph, edge);
            return ret;
        }
        #endregion
        ...
        public static int GraphAddEdgeByPtr(CvGraph graph, CvGraphEdge startVtx, CvGraphEdge endVtx, CvGraphEdge edge, IntPtr insertedEdge)
        {
            ...
            var ret = NativeMethods.cvGraphAddEdgeByPtr(graph.CvPtr, startVtx.CvPtr, endVtx.CvPtr, ToPtr(edge), ref insertedEdge);
            KeepAlive(graph, startVtx, endVtx, edge);
            return ret;
        }
        #endregion
        #region GraphEdgeIdx
        ...
        public static void GraphRemoveEdge(CvGraph graph, int startIdx, int endIdx)
        {
            ...
            NativeMethods.cvGraphRemoveEdge(graph.CvPtr, startIdx, endIdx);
            GC.KeepAlive(graph);
        }
        #endregion
        ...
        public static void GraphRemoveEdgeByPtr(CvGraph graph, CvGraphVtx startVtx, CvGraphVtx endVtx)
        {
            ...
            NativeMethods.cvGraphRemoveEdgeByPtr(graph.CvPtr, startVtx.CvPtr, endVtx.CvPtr);
        ...
        public static int GraphRemoveVtx(CvGraph graph, int index)
        {
            ...
            var ret = NativeMethods.cvGraphRemoveVtx(graph.CvPtr, index);
            GC.KeepAlive(graph);
            return ret;
        }
        #endregion
        ...
        public static int GraphRemoveVtxByPtr(CvGraph graph, CvGraphVtx vtx)
        {
            ...
            var ret = NativeMethods.cvGraphRemoveVtxByPtr(graph.CvPtr, vtx.CvPtr);
            KeepAlive(graph, vtx);
            return ret;
        }
        #endregion
        ...
        public static int GraphVtxDegree(CvGraph graph, int vtxIdx)
        {
            if (graph == null)
                throw new ArgumentNullException("graph");
            var ret = NativeMethods.cvGraphVtxDegree(graph.CvPtr, vtxIdx);
            GC.KeepAlive(graph);
            return ret;
        }
        #endregion
        ...
        public static int GraphVtxDegreeByPtr(CvGraph graph, CvGraphVtx vtx)
        {
            ...
            var ret = NativeMethods.cvGraphVtxDegreeByPtr(graph.CvPtr, vtx.CvPtr);
            KeepAlive(graph, vtx);
            return ret;
        }
        #endregion
