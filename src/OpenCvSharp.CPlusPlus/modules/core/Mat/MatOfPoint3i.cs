...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class MatOfPoint3i : Mat<Point3i, MatOfPoint3i>
    {
...
#endif
        public MatOfPoint3i(MatOfPoint3i m, Range rowRange, Range? colRange = null)
...
#endif
        public MatOfPoint3i(int rows, int cols, IntPtr data, long step = 0)
        ...
        /// If the parameter is missing (set to AUTO_STEP ), no padding is assumed and the actual step is calculated as cols*elemSize() .</param>
#endif
        public MatOfPoint3i(int rows, int cols, Point3i[] data, long step = 0)
            : base(rows, cols, ThisType, data, step)
        {
        }
#if LANG_JP
        ...
        /// 
        /// </summary>
        public sealed unsafe class Indexer : MatIndexer<Point3i>
        {
            ...
            public override Point3i this[int i0]
            {
                get
                {
            ...
            /// <returns>A value to the specified array element.</returns>
            public override Point3i this[int i0, int i1]
            {
                get
                {
            ...
            /// <returns>A value to the specified array element.</returns>
            public override Point3i this[int i0, int i1, int i2]
            {
                get
                {
            ...
            /// <returns>A value to the specified array element.</returns>
            public override Point3i this[params int[] idx]
            {
                get
                {
                    long offset = 0;
        ...
        public static MatOfPoint3i FromArray(params Point3i[] arr)
        {
            ...
            var mat = new MatOfPoint3i(numElems, 1);
        ...
        public static MatOfPoint3i FromArray(Point3i[,] arr)
        {
            ...
            var mat = new MatOfPoint3i(rows, cols);
            mat.SetArray(0, 0, arr);
            return mat;
        }
#if LANG_JP
        ...
        public override Point3i[] ToArray()
        {
            ...
            var arr = new Point3i[numOfElems];
            GetArray(0, 0, arr);
            return arr;
        }
        /// <summary>
        ...
        public override Point3i[,] ToRectangularArray()
        {
            ...
            Point3i[,] arr = new Point3i[Rows, Cols];
            GetArray(0, 0, arr);
            return arr;
        }
        #endregion
