...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class MatOfPoint3d : Mat<Point3d, MatOfPoint3d>
    {
...
#endif
        public MatOfPoint3d(MatOfPoint3d m, Range rowRange, Range? colRange = null)
...
#endif
        public MatOfPoint3d(int rows, int cols, IntPtr data, long step = 0)
        ...
        /// If the parameter is missing (set to AUTO_STEP ), no padding is assumed and the actual step is calculated as cols*elemSize() .</param>
#endif
        public MatOfPoint3d(int rows, int cols, Point3d[] data, long step = 0)
            : base(rows, cols, ThisType, data, step)
        {
        }
#if LANG_JP
        ...
        /// 
        /// </summary>
        public sealed unsafe class Indexer : MatIndexer<Point3d>
        {
            ...
            public override Point3d this[int i0]
            {
                get
                {
            ...
            /// <returns>A value to the specified array element.</returns>
            public override Point3d this[int i0, int i1]
            {
                get
                {
            ...
            /// <returns>A value to the specified array element.</returns>
            public override Point3d this[int i0, int i1, int i2]
            {
                get
                {
            ...
            /// <returns>A value to the specified array element.</returns>
            public override Point3d this[params int[] idx]
            {
                get
                {
                    long offset = 0;
        ...
        public static MatOfPoint3d FromArray(params Point3d[] arr)
        {
            ...
            var mat = new MatOfPoint3d(numElems, 1);
        ...
        public static MatOfPoint3d FromArray(Point3d[,] arr)
        {
            ...
            var mat = new MatOfPoint3d(rows, cols);
            mat.SetArray(0, 0, arr);
            return mat;
        }
#if LANG_JP
        ...
        public override Point3d[] ToArray()
        {
            ...
            var arr = new Point3d[numOfElems];
            GetArray(0, 0, arr);
            return arr;
        }
        /// <summary>
        ...
        public double[] ToPrimitiveArray()
        {
            ...
            if (numOfElems == 0)
                return new double[0];
            var arr = new double[numOfElems * ThisChannels];
            GetArray(0, 0, arr);
            return arr;
        }
        /// <summary>
