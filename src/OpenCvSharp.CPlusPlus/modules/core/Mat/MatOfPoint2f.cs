...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class MatOfPoint2f : Mat<Point2f, MatOfPoint2f>
    {
...
#endif
        public MatOfPoint2f(MatOfPoint2f m, Range rowRange, Range? colRange = null)
...
#endif
        public MatOfPoint2f(int rows, int cols, IntPtr data, long step = 0)
        ...
        /// If the parameter is missing (set to AUTO_STEP ), no padding is assumed and the actual step is calculated as cols*elemSize() .</param>
#endif
        public MatOfPoint2f(int rows, int cols, Point2f[] data, long step = 0)
            : base(rows, cols, ThisType, data, step)
        {
        }
#if LANG_JP
        ...
        public static MatOfPoint2f FromArray(params Point2f[] arr)
        {
            ...
            var mat = new MatOfPoint2f(numElems, 1);
        ...
        public static MatOfPoint2f FromArray(Point2f[,] arr)
        {
            ...
            var mat = new MatOfPoint2f(rows, cols);
            mat.SetArray(0, 0, arr);
            return mat;
        }
#if LANG_JP
