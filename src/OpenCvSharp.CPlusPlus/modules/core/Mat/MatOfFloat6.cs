...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class MatOfFloat6 : Mat<Vec6f, MatOfFloat6>
    {
...
#endif
        public MatOfFloat6(MatOfFloat6 m, Range rowRange, Range? colRange = null)
...
#endif
        public MatOfFloat6(int rows, int cols, IntPtr data, long step = 0)
        ...
        /// If the parameter is missing (set to AUTO_STEP ), no padding is assumed and the actual step is calculated as cols*elemSize() .</param>
#endif
        public MatOfFloat6(int rows, int cols, Vec6f[] data, long step = 0)
            : base(rows, cols, ThisType, data, step)
        {
        }
#if LANG_JP
        ...
        public static MatOfFloat6 FromArray(params Vec6f[] arr)
        {
            ...
            var mat = new MatOfFloat6(numElems, 1);
        ...
        public static MatOfFloat6 FromArray(Vec6f[,] arr)
        {
            ...
            var mat = new MatOfFloat6(rows, cols);
            mat.SetArray(0, 0, arr);
            return mat;
        }
#if LANG_JP
