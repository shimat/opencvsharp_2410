...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class MatOfPoint3f : Mat<Point3f, MatOfPoint3f>
    {
...
#endif
        public MatOfPoint3f(MatOfPoint3f m, Range rowRange, Range? colRange = null)
...
#endif
        public MatOfPoint3f(int rows, int cols, IntPtr data, long step = 0)
        ...
        /// If the parameter is missing (set to AUTO_STEP ), no padding is assumed and the actual step is calculated as cols*elemSize() .</param>
#endif
        public MatOfPoint3f(int rows, int cols, Point3f[] data, long step = 0)
            : base(rows, cols, ThisType, data, step)
        {
        }
#if LANG_JP
        ...
        /// 
        /// </summary>
        public sealed unsafe class Indexer : MatIndexer<Point3f>
        {
            ...
            public override Point3f this[int i0]
            {
                get
                {
            ...
            /// <returns>A value to the specified array element.</returns>
            public override Point3f this[int i0, int i1]
            {
                get
                {
            ...
            /// <returns>A value to the specified array element.</returns>
            public override Point3f this[int i0, int i1, int i2]
            {
                get
                {
            ...
            /// <returns>A value to the specified array element.</returns>
            public override Point3f this[params int[] idx]
            {
                get
                {
                    long offset = 0;
        ...
        public static MatOfPoint3f FromArray(Point3f[,] arr)
        {
            ...
            var mat = new MatOfPoint3f(rows, cols);
            mat.SetArray(0, 0, arr);
            return mat;
        }
#if LANG_JP
        ...
        public override Point3f[] ToArray()
        {
            ...
            var arr = new Point3f[numOfElems];
            GetArray(0, 0, arr);
            return arr;
        }
        /// <summary>
        ...
        public float[] ToPrimitiveArray()
        {
            ...
            if (numOfElems == 0)
                return new float[0];
            var arr = new float[numOfElems * ThisChannels];
            GetArray(0, 0, arr);
            return arr;
        }
        /// <summary>
