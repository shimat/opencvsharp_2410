...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class MatOfPoint : Mat<Point, MatOfPoint>
    {
...
#endif
        public MatOfPoint(MatOfPoint m, Range rowRange, Range? colRange = null)
...
#endif
        public MatOfPoint(int rows, int cols, IntPtr data, long step = 0)
        ...
        /// If the parameter is missing (set to AUTO_STEP ), no padding is assumed and the actual step is calculated as cols*elemSize() .</param>
#endif
        public MatOfPoint(int rows, int cols, Point[] data, long step = 0)
            : base(rows, cols, ThisType, data, step)
        {
        }
#if LANG_JP
        ...
        /// 
        /// </summary>
        public sealed unsafe class Indexer : MatIndexer<Point>
        {
