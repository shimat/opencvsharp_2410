...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class MatOfPoint2d : Mat<Point2d, MatOfPoint2d>
    {
...
#endif
        public MatOfPoint2d(MatOfPoint2d m, Range rowRange, Range? colRange = null)
...
#endif
        public MatOfPoint2d(int rows, int cols, IntPtr data, long step = 0)
        ...
        /// If the parameter is missing (set to AUTO_STEP ), no padding is assumed and the actual step is calculated as cols*elemSize() .</param>
#endif
        public MatOfPoint2d(int rows, int cols, Point2d[] data, long step = 0)
            : base(rows, cols, ThisType, data, step)
        {
        }
#if LANG_JP
        ...
        public static MatOfPoint2d FromArray(Point2d[,] arr)
        {
            ...
            var mat = new MatOfPoint2d(rows, cols);
            mat.SetArray(0, 0, arr);
            return mat;
        }
#if LANG_JP
