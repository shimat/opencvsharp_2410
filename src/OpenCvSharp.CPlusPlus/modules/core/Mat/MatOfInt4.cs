...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class MatOfInt4 : Mat<Vec4i, MatOfInt4>
    {
...
#endif
        public MatOfInt4(int rows, int cols, IntPtr data, long step = 0)
        ...
        /// If the parameter is missing (set to AUTO_STEP ), no padding is assumed and the actual step is calculated as cols*elemSize() .</param>
#endif
        public MatOfInt4(int rows, int cols, Vec4i[] data, long step = 0)
            : base(rows, cols, ThisType, data, step)
        {
        }
#if LANG_JP
        ...
        public static MatOfInt4 FromArray(params Vec4i[] arr)
        {
            ...
            var mat = new MatOfInt4(numElems, 1);
        ...
        public static MatOfInt4 FromArray(Vec4i[,] arr)
        {
            ...
            var mat = new MatOfInt4(rows, cols);
            mat.SetArray(0, 0, arr);
            return mat;
        }
#if LANG_JP
