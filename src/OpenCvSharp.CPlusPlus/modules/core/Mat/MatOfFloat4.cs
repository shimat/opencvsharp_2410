...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class MatOfFloat4 : Mat<Vec4f, MatOfFloat4>
    {
...
#endif
        public MatOfFloat4(MatOfFloat4 m, Range rowRange, Range? colRange = null)
...
#endif
        public MatOfFloat4(int rows, int cols, IntPtr data, long step = 0)
        ...
        /// If the parameter is missing (set to AUTO_STEP ), no padding is assumed and the actual step is calculated as cols*elemSize() .</param>
#endif
        public MatOfFloat4(int rows, int cols, Vec4f[] data, long step = 0)
            : base(rows, cols, ThisType, data, step)
        {
        }
#if LANG_JP
        ...
        public static MatOfFloat4 FromArray(params Vec4f[] arr)
        {
            ...
            var mat = new MatOfFloat4(numElems, 1);
        ...
        public static MatOfFloat4 FromArray(Vec4f[,] arr)
        {
            ...
            var mat = new MatOfFloat4(rows, cols);
            mat.SetArray(0, 0, arr);
            return mat;
        }
#if LANG_JP
