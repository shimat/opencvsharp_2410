...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class MatOfDouble3 : Mat<Vec3d, MatOfDouble3>
    {
...
#endif
        public MatOfDouble3(MatOfDouble3 m, Range rowRange, Range? colRange = null)
...
#endif
        public MatOfDouble3(int rows, int cols, IntPtr data, long step = 0)
        ...
        public static MatOfDouble3 FromArray(params Vec3d[] arr)
        {
            ...
            var mat = new MatOfDouble3(numElems, 1);
