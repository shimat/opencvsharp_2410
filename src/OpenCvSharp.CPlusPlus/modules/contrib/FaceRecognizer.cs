...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class FaceRecognizer : Algorithm
    {
        ...
        {
            IntPtr p = NativeMethods.contrib_createEigenFaceRecognizer(numComponents, threshold);
            return FromPtr(p);
        }
        /// <summary>
        /// 
        ...
        {
            IntPtr p = NativeMethods.contrib_createFisherFaceRecognizer(numComponents, threshold);
            return FromPtr(p);
        }
        /// <summary>
        /// 
        ...
        {
            IntPtr p = NativeMethods.contrib_createLBPHFaceRecognizer(radius, neighbors, gridX, gridY, threshold);
            return FromPtr(p);
        }
    ...
    ///</param>
        ...
        {
            get { return NativeMethods.contrib_FaceRecognizer_info(ptr); }
        }
